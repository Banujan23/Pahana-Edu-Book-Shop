...
<head>
  ...
  <style>
    ...
    .form-select, .form-control, .input-group-text, textarea{
  ...
  <nav class="navbar navbar-expand-lg py-3">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center gap-3" href="main-menu.jsp">
        <span class="brand-mark"><i class="fa-solid fa-cart-plus"></i></span>
...
<main class="container py-5 flex-grow-1">
  <header class="text-center mb-4">
    <h1 class="h4 fw-bold mb-1 section-title d-inline-block">Create Bill</h1>
    <p class="text-secondary mb-0">Select a customer and add items to the bill</p>
  </header>
      ...
      <form action="BillServlet" method="post" id="billForm" class="needs-validation" novalidate>
        ...
        <div class="mb-4">
          <label for="customer_id" class="form-label fw-semibold">
            <i class="fa-solid fa-user-tag me-2"></i>Select Customer
          </label>
          ...
          <div class="form-text"><i class="fa-regular fa-circle-question me-1"></i>Use the account number stored in the system.</div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <a href="BillServlet" class="btn btn-ghost"><i class="fa-solid fa-arrow-left-long me-2"></i>Back to Billing</a>
